...
router.get('/admin/:id/question/:id',auth.authAdmin, adminCtrl.getQuestionById);
// road for get all tag
router.get('/admin/:id/tag',auth.authAdmin, adminCtrl.getAllTags);
// road for get tag by id
router.get('/admin/:id/tag/:id',auth.authAdmin, adminCtrl.getTagById);
...
router.delete('/admin/:id/question/:id',auth.authAdmin, adminCtrl.deleteQuestion);
// road for delete a tag
router.delete('/admin/:id/tag/:id',auth.authAdmin, adminCtrl.deleteTag);
