...
('Combien faut-il de cure-dents empilés pour faire la taille de l''homme le plus grand du monde ? ','54.4'),
...
('Combien faut-il de burgers empilés pour avoir la taille de l''homme le plus grand du monde ? ','27.2'),
...
('Combien de pays de la superficie du Liechtenstein la Russie peut-elle contenir?','107 062.5'),
('Combien faut-il de fois cumuler le record de saut en longeur pour arriver à dépasser la longeur de la voiture la plus longue du monde ? ','3.4'),
('Combien faudrait-il manger de bannane pour arriver au même nombre de calories qu''un strongman ?','151.6'),
('Combien de couleur type le caméléon possède-t-il ?','4'),
('Combien de fois faudrait-il peser la plus grosse pépite d''or pour peser aussi loud que le cerceuil de Toutenkhamon ? ','1.5'),
...
('Combien de fois faudrait-il multiplier la population de Paris pour arriver à celle de la Chine ? ','640.8'),
